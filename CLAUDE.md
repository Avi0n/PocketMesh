...
## Research and planning instructions

- Prioritize technologies that are iOS 18+
- Use sosumi mcp to look up Apple documentation
- Use web-search-researcher agent for research


## Build and testing instructions

- When building, use destination "platform=iOS Simulator,name=iPhone 16e"
- This project uses xcodegen, don't edit .xcodeproj directly.
- Use xcsift to transform verbose Xcode build/testing output into a concise , structured format that is easy to parse.
